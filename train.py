...
def main(params):
    ...
    params.db_path = os.path.join(params.main_dir, f'data/{params.dataset}/extend_subgraphs_en_{params.enclosing_sub_graph}_neg_{params.num_neg_samples_per_link}_hop_{params.hop}')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--relnum", type=int, default=1, #30,
                        help="the number of relative relations")     
