...
if __name__ == '__main__':
    ...
    parser.add_argument("--experiment_name", "-e", type=str, default="WN18RR_v3",
                        help="A folder with this name would be created to dump saved models and log files")
    parser.add_argument("--dataset", "-d", type=str, default="WN18RR_v3_ind",
                        help="Dataset string")
    parser.add_argument("--train_file", "-tf", type=str, default="train",
                        help="Name of file containing training triplets")
    parser.add_argument("--test_file", "-t", type=str, default="test_case",
    ...
    parser.add_argument("--relnum", type=int, default=1,
